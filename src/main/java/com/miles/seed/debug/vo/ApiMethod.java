...
public class ApiMethod implements Serializable {
	...
	public String toString() {
		return "ApiMethod [" + (name != null ? "name=" + name + ", " : "") + (category != null ? "category=" + category + ", " : "") + (description != null ? "description=" + description + ", " : "") + (url != null ? "url=" + Arrays.toString(url) + ", " : "") + (param != null ? "param=" + param + ", " : "") + (apiReturn != null ? "apiReturn=" + apiReturn + ", " : "") + "http=" + http + ", " + (apiUsers != null ? "apiUsers=" + apiUsers + ", " : "") + (authors != null ? "authors=" + Arrays.toString(authors) : "") + "]";
	}
}